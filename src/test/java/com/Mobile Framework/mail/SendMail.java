...

{
...

    {
		...
		try {
			FileInputStream fs = new FileInputStream(System.getProperty("user.dir")+"//src//test//java//com//USICS//resources//pro.properties");
			pro.load(fs);
   ...
   //      String xsltReportPath=reportFolder+"Reports.zip";
         ...
         // mail extent reports
                ...
                sendMail("shanthi_7583@yahoo.co.in",
                		            "7@oracle",
                		            "smtp.mail.yahoo.com",
                		            "587",
                		            "true",
